...
/usr/libexec/PlistBuddy -c "Add :CFBundleShortVersionString string 0.3.12" "$APP_ROOT/Contents/Info.plist"
/usr/libexec/PlistBuddy -c "Add :CFBundleVersion string 15" "$APP_ROOT/Contents/Info.plist"
